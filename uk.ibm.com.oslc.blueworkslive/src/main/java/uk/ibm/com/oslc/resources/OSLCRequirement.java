...
public final class OSLCRequirement
       extends ChangeRequest
{
	...
	public static OSLCRequirement fromRequirement(RequirementInfo req)
		...
		else
		{
			...
			RequirementInfo parentInfo = IRequirementsConnector.getInstance().getRequirementById(req.getParent());
			String parentEndPoint = IRequirementsConnector.getInstance().getEndpointStringForRequirement(parentInfo);
			String parentName = parentInfo.getName();
			String parentLink = "<a target=\"_blank\" href=\"" + parentEndPoint +"\" >" + parentName + "</a>";
		...
		else
		{
			for (RequirementInfo requirementInfo : children) {
				...
				IRequirementsConnector.getInstance().getEndpointStringForRequirement(requirementInfo);
	...
	public String getModifiedDateAsString()
	{
		...
		if ( getModified() !=null)
		{
			SimpleDateFormat format = new SimpleDateFormat("EEE, MMM d, yyyy HH:mm");
