...
<!-- Jazz Root Services, see:
 ...
 -->
<rdf:Description rdf:about="http://oslcadapter.net:8080/bwloslc/rootservices"
	...
	<dcterms:title>OSLC-RM Adapter/BlueworksLive Jazz Root Services</dcterms:title>
	<oslc_rm:rmServiceProviders rdf:resource="<%= catalogUri %>" />
	<jfs:oauthRealmName>Blueworks</jfs:oauthRealmName>
