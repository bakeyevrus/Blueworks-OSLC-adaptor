...
<%
	...
	ServiceProvider serviceProvider = (ServiceProvider) request
			.getAttribute("serviceProvider");
	...
	String creationFactory = creationFactories[0].getCreation()
			.toString();
	...
	QueryCapability[] queryCapabilities = service
			.getQueryCapabilities();
	String queryCapability = queryCapabilities[0].getQueryBase()
			.toString();
	String queryShape = queryCapabilities[0].getResourceShape()
			.toString();
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
<title><%=toolName%> OSLC Adapter: Service Provider for <%=serviceProvider.getTitle() + "("
					+ serviceProvider.getIdentifier() + ")"%></title>
...
<body onload="">
	...
	<div id="header">
		<div id="banner"></div>
		<table border="0" cellspacing="0" cellpadding="5" id="titles">
			<tr>
				<td id="title">
					<p>IBM BlueworksLive OSLC Adapter: Service Provider</p>
				</td>
				<td id="information">
					<p class="header_addl_info">version 0.2</p>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="bugzilla-body">
		<div id="page-index">
			...
			<img src="<%=baseURI%>/images/resources/BlueworksPreviewLogo.gif"
				alt="icon" width="156" height="28" />

			<h1>
				Service Provider for
				<%=serviceProvider.getTitle() + "("
					+ serviceProvider.getIdentifier() + ")"%></h1>

			<p>Enables navigation to OSLC-RM/CCM Resource Selector Dialogs,
				to enable linking to any BlueworksLive process or activity.</p>

			<table>
				<tr>
					<td><b>This document</b>:</td>
					<td><a href="<%=serviceProvider.getAbout()%>"> <%=serviceProvider.getAbout()%></a></td>
				</tr>
				<tr>
					<td><b>"<%=toolName%>"
					</b>:</td>
			...
			<h2>OSLC-CCM Resource Selector Dialog</h2>
			<p>
				TODO
			</p>
			...
			<h2>OSLC-CCM Resource Creator Dialog</h2>
			<p>
				TODO
			</p>
			...
			<p>
				<a href="<%=creationFactory%>"> <%=creationFactory%></a>
			</p>
			<p>
				<a href="<%=creationShape%>"> <%=creationShape%></a>
			</p>
			
			<h2>OSLC-CCM Resource Creation Factory and Resource Shape</h2>
			<p>
				TODO
			</p>
			<p>
			...
			<p>
				<a href="<%=queryCapability%>"> <%=queryCapability%></a>
			</p>
			<p>
				<a href="<%=queryShape%>"> <%=queryShape%></a>
			</p>
			
			<h2>OSLC-CCM Resource Query Capability and Resource Shape</h2>
			<p>
				TODO
			</p>
			<p>
	...
	<div id="footer">
		...
		<div class="outro">
			<div
				...
				<b>Based on</b> the OSLC Tools Adapter Server 0.1 brought to you by
				<a href="http://eclipse.org/lyo">Eclipse Lyo</a><br>
			</div>
		</div>
	</div>
</body>
